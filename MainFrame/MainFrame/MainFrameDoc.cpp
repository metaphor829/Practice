...
// MainFrameDoc.cpp : CMainFrameDoc 类的实现
//
...
// 缩略图的支持
void CMainFrameDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMainFrameDoc::InitializeSearchContent()
{
...
void CMainFrameDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
